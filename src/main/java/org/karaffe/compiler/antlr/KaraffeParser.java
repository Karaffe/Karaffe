...
public class KaraffeParser extends Parser {
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public List<TerminalNode> NEWLINE() { return getTokens(KaraffeParser.NEWLINE); }
		public TerminalNode NEWLINE(int i) {
			return getToken(KaraffeParser.NEWLINE, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof KaraffeListener ) ((KaraffeListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof KaraffeListener ) ((KaraffeListener)listener).exitProg(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof KaraffeVisitor ) return ((KaraffeVisitor<? extends T>)visitor).visitProg(this);
	...
	public static class ExprContext extends ParserRuleContext {
		public TerminalNode INT() { return getToken(KaraffeParser.INT, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
